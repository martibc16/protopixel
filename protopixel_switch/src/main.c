...
static const char *TAG = "SWITCH_app_main";
...
//The button has been pressed one time, this invokes this callback --> we send the new state to the lamp
...
//The button has been long-pressed, this invokes this callback --> we increase brightness and send the new state
...
//The lamp has been turned on. This info is transmited via ESP-NOW and we recieve it here, we now turn on the led on the switch
